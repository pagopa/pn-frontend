...
export interface BffPgGroup {
    ...
    /**
     * 
     * @type {BffPgGroupStatus}
     * @memberof BffPgGroup
     */
    'status'?: BffPgGroupStatus;
}
...
export const InfoRecipientApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Get PA list
         * @param {string} [paNameFilter] Se valorizzato indica il prefisso della denominazione della PA
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPAListV1: async (paNameFilter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/bff/v1/pa-list`;
            ...
            if (paNameFilter !== undefined) {
                localVarQueryParameter['paNameFilter'] = paNameFilter;
            }
...
export const InfoRecipientApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPAListV1(paNameFilter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PaSummary>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPAListV1(paNameFilter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['InfoRecipientApi.getPAListV1']?.[localVarOperationServerIndex]?.url;
...
export const InfoRecipientApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getPAListV1(paNameFilter?: string, options?: any): AxiosPromise<Array<PaSummary>> {
            return localVarFp.getPAListV1(paNameFilter, options).then((request) => request(axios, basePath));
        },
        /**
         * This operation retrieves the PG Groups from Self Care.
         * @summary Get PG Groups list
...
export class InfoRecipientApi extends BaseAPI {
     ...
     */
    public getPAListV1(paNameFilter?: string, options?: RawAxiosRequestConfig) {
        return InfoRecipientApiFp(this.configuration).getPAListV1(paNameFilter, options).then((request) => request(this.axios, this.basePath));
    }
