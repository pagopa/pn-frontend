...
import NewDelegation from '../NewDelegation.page';
...
describe('NewDelegation page', () => {
  ...
  it('renders the component desktop view', () => {
    ...
    const result = render(<NewDelegation />, initialState(false));
  ...
  it('renders the component after a delegation is created', () => {
    useIsMobileSpy.mockReturnValue(true);
    const result = render(<NewDelegation />, initialState(true));
