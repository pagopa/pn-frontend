...
const PrivacyPolicyPage = () => (
    <>
      <Container
        ...
        sx={{py: 4}}
        >
        <Typography variant="h2">Termini e condizioni d’uso</Typography>

        <Typography variant="h4">Piattaforma Notifiche Digitali</Typography>
        <Typography variant="h5">Destinatari persone fisiche</Typography>
        <Box mt={3}>
