...
describe('SpecialContacts Component', async () => {
  ...
  it('renders component - no contacts', () => {
    ...
    // render component
    const { container, queryAllByTestId } = render(<SpecialContacts />);
  ...
  it('edit address', async () => {
    mock.onGet('/bff/v1/pa-list').reply(200, parties);
    // render component
    const { getByTestId, getAllByTestId } = render(<SpecialContacts />);
    const specialContactForms = getAllByTestId(`special_pec`);
  ...
  it('delete address', () => {
    mock.onGet('/bff/v1/pa-list').reply(200, parties);
    // render component
    const { getAllByTestId } = render(<SpecialContacts />);
    const specialContactForms = getAllByTestId(`special_pec`);
