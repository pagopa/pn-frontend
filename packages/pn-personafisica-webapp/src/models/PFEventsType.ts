export enum PFEventsType {
  ...
  SEND_ADD_SERCQ_SEND_POP_UP_APP_IO_BACK = 'SEND_ADD_SERCQ_SEND_POP_UP_APP_IO_BACK',
  SEND_ADD_SERCQ_SEND_POP_UP_APP_IO_CONTINUE = 'SEND_ADD_SERCQ_SEND_POP_UP_APP_IO_CONTINUE',
