...
export const ACCESSIBILITY_PARTICULAR_LINK = {
  LANDING_URL_PATTERN: process.env.NEXT_PUBLIC_ACCESSIBILITY_PARTICULAR_LANDING_URL_PATTERN,
  PARTICULAR_ACCESSIBILITY_URL: process.env.NEXT_PUBLIC_ACCESSIBILITY_PARTICULAR_ACCESSIBILITY_URL,
};
