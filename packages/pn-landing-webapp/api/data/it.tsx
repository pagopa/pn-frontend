...
const paHero: HeroProps = {
  ...
  subtitle:
    "E da oggi anche a farsi. Piattaforma Notifiche digitalizza la gestione delle notifiche a valore legale, semplificando il processo per tutti: chi le invia, e chi le riceve.",
  ctaPrimary: {
  ...
  items: [
    {
      ...
      title: "Unico",
      subtitle:
        "Le notifiche sono inviate, gestite e monitorate in un solo posto, in collaborazione con i colleghi",
    },
    {
      icon: <CieIcon />,
      title: "Semplice",
      subtitle:
        "Si possono caricare notifiche sia tramite API che manualmente: caricati i documenti, la piattaforma si occupa dell’invio e tiene traccia dei cambi di stato",
    },
    {
      icon: <CieIcon />,
      title: "Immediato",
      subtitle:
        "Se il destinatario ha un recapito digitale, i tempi di invio diminuiscono drasticamente",
    },
    {
      icon: <CieIcon />,
      title: "Certo",
      subtitle:
        "La certezza di consegna aumenta e  il pagamento di quanto dovuto dal destinatario si facilita",
    },
  ],
};
...
const paWalkthrough: WalkthroughProps = {
  ...
  items: [
    ...
    },
    {
      ...
      subtitle:
        "Piattaforma Notifiche verifica la correttezza e completezza delle informazioni. Ad ogni cambio di stato, viene sempre generata la relativa attestazione opponibile a terzi.",
    },
    {
      icon: <CieIcon />,
      title: "La notifica viene inviata",
      subtitle:
        "Poi, la piattaforma comunica al destinatario la presenza di una notifica tramite diversi possibili canali: PEC, App IO, email, SMS. In alternativa, ricerca un indirizzo fisico e invia una raccomandata cartacea.",
    },
    {
      icon: <CieIcon />,
      title: "Il destinatario la riceve",
      subtitle:
        "Ricevuto l’avviso di avvenuta ricezione, il destinatario accede alla piattaforma. Lì, può scaricare gli atti notificati e pagare contestualmente quanto dovuto, grazie all’integrazione con pagoPA.",
    },
  ],
};
