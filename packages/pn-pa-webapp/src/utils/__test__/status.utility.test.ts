...
import { NotificationStatusHistory, NotificationDetailTimeline, TimelineCategory } from "../../redux/notification/types";
...
const notificationStatusHistory: Array<NotificationStatusHistory> = [
  {status: NotificationStatus.ACCEPTED, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-1']},
  {status: NotificationStatus.DELIVERED, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-2']},
  {status: NotificationStatus.REFUSED, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-3']},
  {status: NotificationStatus.DELIVERING, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-4']},
  {status: NotificationStatus.UNREACHABLE, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-5']},
  {status: NotificationStatus.PAID, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-6']},
  {status: NotificationStatus.IN_VALIDATION, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-7']},
  {status: NotificationStatus.EFFECTIVE_DATE, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-8']},
  {status: NotificationStatus.VIEWED, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-9']},
  {status: NotificationStatus.CANCELED, activeFrom: '', relatedTimelineElements: ['mocked-timeline-id-10']},
];
...
test('return timeline step data - ACCEPTED', () => {
  ...
  const timeLineData = getNotificationStatusLabelAndColorFromTimelineCategory(timelineStep, notificationStatusHistory);
