...
export enum ServerResponseErrorCode {
  ...
  // PN_DELIVERY_TIMEOUT, unlike other error codes, does not have a dedicated AppError class.
  // We only need the type here because this error is handled at page level
  // (Dashboard empty state) instead of via a error toast.
