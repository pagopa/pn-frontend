...
const API_NOTIFICATION_DETAIL_PATH = `${API_VERSION_SEGMENT_2_0}/${API_NOTIFICATIONS_SENT_PATH}/:${API_NOTIFICATIONS_IUN_PARAMETER}`;
...
const API_NOTIFICATION_CANCEL_NOTIFICATION = `${API_VERSION_SEGMENT_2_0}/${API_NOTIFICATIONS_BASE}/${API_NOTIFICATION_CANCEL}/:${API_NOTIFICATIONS_IUN_PARAMETER}`;
