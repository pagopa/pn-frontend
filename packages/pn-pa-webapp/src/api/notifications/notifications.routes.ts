...
const API_VERSION_SEGMENT_0_2 = 'v2.0';
...
const API_NOTIFICATION_DETAIL_PATH = `${API_VERSION_SEGMENT_0_2}/${API_NOTIFICATIONS_SENT_PATH}/:${API_NOTIFICATIONS_IUN_PARAMETER}`;
...
const API_NOTIFICATION_CANCEL_NOTIFICATION = `${API_VERSION_SEGMENT_0_2}/${API_NOTIFICATIONS_BASE}/${API_NOTIFICATION_CANCEL}/:${API_NOTIFICATIONS_IUN_PARAMETER}`;
