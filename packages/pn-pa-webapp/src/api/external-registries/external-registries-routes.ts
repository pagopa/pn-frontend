...
const API_GET_INSTITUTIONS = `${API_EXTERNAL_REGISTRIES_BASE_PATH}/${API_INSTITUTIONS_SEGMENT}`;
const API_GET_INSTITUTION_PRODUCTS = `${API_EXTERNAL_REGISTRIES_BASE_PATH}/${API_INSTITUTIONS_SEGMENT}/:${API_INSTITUTION_ID_PARAMETER}/${API_PRODUCTS_SEGMENT}`;
