      ...
      <ItemsCard>
        <ItemsCardBody>
          <ItemsCardContents>
            ...
            <ItemsCardContent body={cardBody}>mocked-card-content-2</ItemsCardContent>
            <ItemsCardContent body={cardBody}>mocked-card-content-3</ItemsCardContent>
          </ItemsCardContents>
        </ItemsCardBody>
      </ItemsCard>
    );
    expect(container).toHaveTextContent(
      'mocked-column-namemocked-card-content-1mocked-column-namemocked-card-content-2mocked-column-namemocked-card-content-3'
    );
  });
});
