...
describe('PnCard', () => {
  ...
  it('render component - no PnContent child', () => {
    ...
    expect(getByText('PnCard can have only 1 child of type PnCardContent')).toBeInTheDocument();
  });
  ...
  it('render component - more than one PnCardHeader', () => {
    ...
    expect(getByText('PnCard can have only 1 child of type PnCardHeader')).toBeInTheDocument();
  });
  ...
  it('render component - more than one PnCardActions', () => {
    ...
    expect(getByText('PnCard can have only 1 child of type PnCardActions')).toBeInTheDocument();
  });
});
