...
const HelpNotificationDetails: React.FC<HelpNotificationDetailsProps> = ({ title,subtitle,courtName, phoneNumber, mail, website }) => (
    <>
        ...
        <Grid container direction="row" alignItems="center" mt={2}>
            ...
            <ButtonNaked color="primary" startIcon={<MailOutlineIcon />} sx={{ ml: 2 }} href={`mailto:${mail}`} target="_blank">
                {mail}
            </ButtonNaked>
