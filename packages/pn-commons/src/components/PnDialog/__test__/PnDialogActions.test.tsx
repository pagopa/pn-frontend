...
describe('PnDialogActions Component', () => {
  it('renders component - desktop', () => {
    ...
    expect(actions).toHaveStyle('flex-direction: row; padding: 24px 32px 32px 32px;');
  ...
  it('renders component - mobile', () => {
    ...
    expect(actions).toHaveStyle('flex-direction: column-reverse; padding: 16px 24px 24px 24px;');
    const buttons = queryAllByTestId('button');
    expect(buttons).toHaveLength(2);
