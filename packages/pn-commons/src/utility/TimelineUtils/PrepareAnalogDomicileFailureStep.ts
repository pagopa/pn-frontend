...
import { PrepareAnalogDomicileFailureDetails } from '../../types/NotificationDetail';
...
export class PrepareAnalogDomicileFailureStep extends TimelineStep {
    ...
    getTimelineStepInfo(payload: TimelineStepPayload): TimelineStepInfo | null {
      ...
      // details
      // ///////////////////////////////////////////////////////////////
      const failureCause = (payload.step.details as PrepareAnalogDomicileFailureDetails).failureCause || 'ZZZ';
  
      const addressData = this.completePhysicalAddressFromAddress((payload.step.details as PrepareAnalogDomicileFailureDetails).foundAddress);
