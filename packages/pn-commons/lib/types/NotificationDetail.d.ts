...
export declare type PaymentHistory = PaidDetails & {
    recipientDenomination: string;
    recipientTaxId: string;
};
export declare type NotificationDetailTimelineDetails = BaseDetails | AarDetails | ViewedDetails | AnalogWorkflowDetails | DigitalWorkflowDetails | AddressInfoDetails | PublicRegistryCallDetails | PublicRegistryResponseDetails | RequestRefusedDetails | ScheduleDigitalWorkflowDetails | SendCourtesyMessageDetails | SendDigitalDetails | SendPaperDetails | PaidDetails | NotHandledDetails;
...
export declare type PaymentAttachmentNameType = number | PaymentAttachmentSName;
...
export declare type DigitalDetails = DigitalWorkflowDetails | PublicRegistryResponseDetails | ScheduleDigitalWorkflowDetails | SendCourtesyMessageDetails | SendDigitalDetails;
export declare type AnalogDetails = SendPaperDetails | AnalogWorkflowDetails | PublicRegistryResponseDetails;
export {};
