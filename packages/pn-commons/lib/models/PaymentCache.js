...
import { PaymentInfoDetail, PaymentStatus, RecipientType, } from './NotificationDetail';
...
const f24Schema = yup
    ...
    .default(undefined)
    .noUnknown(true);
const notificationDetailDocumentSchema = attachmentSchema
...
const pagoPaF24Schema = yup
    ...
    .noUnknown(true);
export const paymentCacheSchema = yup
    .object()
    .shape({
