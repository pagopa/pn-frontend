...
export function DOWNTIME_HISTORY(params) {
    /* eslint-disable functional/immutable-data */
    const queryParams = { [API_DOWNTIME_FROM_TIME_PARAMETER]: params.startDate };
    const conditionallyAddParam = (name, value) => {
        if (value != null) {
...
export function DOWNTIME_LEGAL_FACT_DETAILS(legalFactId) {
    return compileRoute({
        prefix: API_DOWNTIME_PREFIX,
