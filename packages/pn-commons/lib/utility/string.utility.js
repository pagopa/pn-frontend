...
export const dataRegex = {
    ...
    simpleServer: /^[A-Za-z0-9.\-/]+$/,
    token: /^[A-Za-z0-9\-._~+/]+$/,
    fiscalCode: /^([A-Z]{6}[0-9LMNPQRSTUV]{2}[ABCDEHLMPRST]{1}[0-9LMNPQRSTUV]{2}[A-Z]{1}[0-9LMNPQRSTUV]{3}[A-Z]{1})$/i,
    pIva: /^\d{11}$/,
    ...
    noticeCode: /^\d{18}$/,
    zipCode: /^(\w|\ |\-)*$/,
    email: /^(?:[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x21\x23-\x5b\x5d-\x7f]|\\[\x20-\x7f])*")@(?:(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?|\[(?:(?:25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(?:25[0-5]|2[0-4]\d|[01]?\d\d?|[a-zA-Z0-9-]*[a-zA-Z0-9]:(?:[\x21-\x5a\x53-\x7f]|\\[\x20-\x7f])+)\])$/,
 ...
 * @returns string
 */
export function sanitizeString(srt) {
