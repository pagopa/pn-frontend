function calcDisplayedPages(pages, numOfDisplayedPages, pageSelected, direction) {
 ...
 * @returns Array
 */
export function calculatePages(pageSize, numOfItems, numOfDisplayedPages, pageSelected) {
