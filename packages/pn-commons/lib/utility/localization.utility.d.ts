...
type LocalizationFunction = (namespace: string | Array<string>, path: string, data?: {
    [key: string]: string | undefined;
}) => string;
export declare const initLocalization: (translateFn: LocalizationFunction, namespaces?: LocalizationNamespaces) => void;
