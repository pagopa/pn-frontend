...
export const companyLegalInfo = () => (_jsxs(_Fragment, { children: [_jsx("strong", { children: "PagoPA S.p.A." }), " \u2014", ' ', getLocalizedOrDefaultLabel('common', 'footer.legal-part-1', 'società per azioni con socio unico - capitale sociale di euro 1,000,000 interamente versato - sede legale in Roma, Piazza Colonna 370'), ",", _jsx("br", {}), getLocalizedOrDefaultLabel('common', 'footer.legal-part-2', 'CAP 00187 - n. di iscrizione a Registro Imprese di Roma, CF e P.IVA 15376371009')] }));
