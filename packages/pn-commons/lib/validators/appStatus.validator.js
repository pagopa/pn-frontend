...
/* ------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------ */
function validateIsoDate(required) {
    return (value) => {
        const isOK = value
...
/* ------------------------------------------------------------------------
      ...
      ------------------------------------------------------------------------ */
export class BEDowntimeValidator extends Validator {
    constructor() {
        super();
        ...
        this.ruleFor('status')
            .isString()
            .isOneOf(Object.values(DowntimeStatus))
            .not()
            .isUndefined();
...
export class AppStatusDTOValidator extends Validator {
    constructor() {
        super();
...
export class DowntimeLogPageDTOValidator extends Validator {
    constructor() {
        super();
        this.ruleFor('result')
            .isArray()
