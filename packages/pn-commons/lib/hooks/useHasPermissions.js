 ...
 * @returns
 */
export function useHasPermissions(currentPermissions, requiredPermissions) {
    ...
    const hasAllPermissions = useMemo(() => !!currentPermissions &&
        requiredPermissions.every((perm) => currentPermissions.includes(perm)), [currentPermissions, requiredPermissions]);
