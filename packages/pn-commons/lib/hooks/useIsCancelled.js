import { NotificationStatus, TimelineCategory } from '../models';
/**
 ...
 */
export const useIsCancelled = ({ notification }) => {
    const timelineCancelled = !!notification.timeline.find((el) => el.category === TimelineCategory.NOTIFICATION_CANCELLED ||
    ...
    return {
        ...
        cancellationInProgress: notification.notificationStatus === NotificationStatus.CANCELLATION_IN_PROGRESS,
