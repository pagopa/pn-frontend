...
const getFooterLinkLabels = (link, defaultLabel) => {
    const footerLink = `footer.${link}`;
    return {
        label: getLocalizedOrDefaultLabel('common', footerLink, defaultLabel),
        ariaLabel: `${getLocalizedOrDefaultLabel('common', 'footer.go-to', 'Vai al link')}: ${getLocalizedOrDefaultLabel('common', footerLink, defaultLabel)}`,
    };
};
export const pagoPALink = () => ({
    href: 'https://www.pagopa.it/it/',
    ariaLabel: getLocalizedOrDefaultLabel('common', 'footer.go-to-pagopa', 'Link: vai al sito di PagoPA S.p.A.'),
});
export const companyLegalInfo = () => (_jsxs(_Fragment, { children: [_jsx("strong", { children: "PagoPA S.p.A." }, void 0), " \u2014", ' ', getLocalizedOrDefaultLabel('common', 'footer.legal-part-1', 'società per azioni con socio unico - capitale sociale di euro 1,000,000 interamente versato - sede legale in Roma, Piazza Colonna 370'), ",", _jsx("br", {}, void 0), getLocalizedOrDefaultLabel('common', 'footer.legal-part-2', 'CAP 00187 - n. di iscrizione a Registro Imprese di Roma, CF e P.IVA 15376371009')] }, void 0));
export const preLoginLinks = (hasTermsOfService = false, privacyPolicyHref, termsOfServiceHref) => {
    const links = {
        // First column
        aboutUs: {
            title: undefined,
            ...
            socialLinks: [
                {
                    ...
                    ariaLabel: getLocalizedOrDefaultLabel('common', 'footer.social', 'Link: vai al sito LinkedIn di PagoPA S.p.A.', { social: 'LinkedIn' }),
                },
                {
                    title: 'Twitter',
                    icon: 'twitter',
                    href: 'https://it.linkedin.com/company/pagopa',
                    ariaLabel: getLocalizedOrDefaultLabel('common', 'footer.social', 'Link: vai al sito LinkedIn di PagoPA S.p.A.', { social: 'Twitter' }),
                },
                {
                    icon: 'instagram',
                    title: 'Instagram',
                    href: 'https://www.instagram.com/pagopaspa/?hl=en',
                    ariaLabel: getLocalizedOrDefaultLabel('common', 'footer.social', 'Link: vai al sito LinkedIn di PagoPA S.p.A.', { social: 'Instagram' }),
                },
                {
                    icon: 'medium',
                    title: 'Medium',
                    href: 'https://medium.com/pagopa-spa',
                    ariaLabel: getLocalizedOrDefaultLabel('common', 'footer.social', 'Link: vai al sito LinkedIn di PagoPA S.p.A.', { social: 'Medium' }),
                },
            ],
            links: [
                {
...
export const postLoginLinks = (privacyPolicyHref, termsOfServiceHref) => [
    {
        label: 'Informativa Privacy',
        href: privacyPolicyHref || `${window.location.origin}${PRIVACY_LINK_RELATIVE_PATH}`,
        ariaLabel: `${getLocalizedOrDefaultLabel('common', 'footer.go-to', 'Vai al link')}: Informativa Privacy`,
        linkType: 'internal',
    },
    {
        ...getFooterLinkLabels('terms-conditions', 'Termini e Condizioni'),
