 ...
 */
export declare function mockApiErrorWrapper(mockNormalComponentFn?: () => JSX.Element | undefined, mockApiErrorComponent?: JSX.Element): ({ apiId, children }: {
    apiId: string;
 ...
 */
export declare const simpleMockForApiErrorWrapper: ({ apiId, children }: {
    apiId: string;
    children: React.ReactNode;
}) => JSX.Element;
...
declare type ApiOutcomeTestHelperType = {
