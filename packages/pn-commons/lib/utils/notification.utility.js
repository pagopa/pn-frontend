...
import { TimelineCategory, NotificationStatus, LegalFactType, NotificationDeliveryMode, DigitalDomicileType, } from '../types';
 ...
 * @returns Array<NotificationDetailDocument>
 */
const populatePaymentHistory = (timeline, recipients) => {
...
export function parseNotificationDetail(notificationDetail) {
    const parsedNotification = {
        ...
        paymentHistory: populatePaymentHistory(notificationDetail.timeline, notificationDetail.recipients),
