        ...
        <CustomDatePicker
          ...
          slotProps={{
            textField: {
              ...
              error: formikInstance.touched.endDate && Boolean(formikInstance.errors.endDate),
              helperText: formikInstance.touched.endDate && String(formikInstance.errors.endDate),
            },
          }}
          disableFuture={true}
