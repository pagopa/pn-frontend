...
/**
 * NotificationReceivedApi - axios parameter creator
 * @export
 */
export const NotificationReceivedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getReceivedNotificationV1: async (iun: string, mandateId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'iun' is not null or undefined
            assertParamExists('getReceivedNotificationV1', 'iun', iun)
            const localVarPath = `/bff/v1/notifications/received/{iun}`
...
/**
 * NotificationReceivedApi - functional programming interface
 * @export
 */
export const NotificationReceivedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getReceivedNotificationV1(iun: string, mandateId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BffFullNotificationV1>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getReceivedNotificationV1(iun, mandateId, options);
...
/**
 * NotificationReceivedApi - factory interface
 * @export
 */
...
/**
 * NotificationReceivedApi - object-oriented interface
 * @export
 * @class NotificationReceivedApi
 * @extends {BaseAPI}
 */
