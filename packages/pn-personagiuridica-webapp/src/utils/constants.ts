...
export const FAQ_DIFFERENT_AMOUNTS_SUFFIX = process.env.REACT_APP_FAQ_DIFFERENT_AMOUNTS_SUFFIX;
export const FAQ_WHAT_IS_AAR = process.env.REACT_APP_FAQ_WHAT_IS_AAR;
export const FAQ_WHAT_IS_COURTESY_MESSAGE = process.env.REACT_APP_FAQ_WHAT_IS_COURTESY_MESSAGE;
