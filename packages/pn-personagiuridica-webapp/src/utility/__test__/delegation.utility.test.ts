...
describe('Delegation utility test', () => {
  ...
  it('sort delegation by name - delegates', () => {
    ...
    let result = sortDelegations('asc', 'displayName', mandatesByDelegator);
    expect(sortedCopy('asc')).toStrictEqual(result);
    // sort descending
    result = sortDelegations('desc', 'displayName', mandatesByDelegator);
  ...
  it('sort delegation by name - delegators', () => {
    ...
    let result = sortDelegations('asc', 'displayName', mandatesByDelegate);
    expect(sortedCopy('asc')).toStrictEqual(result);
    // sort descending
    result = sortDelegations('desc', 'displayName', mandatesByDelegate);
    expect(sortedCopy('desc')).toStrictEqual(result);
  });
