...
describe('Notifications routes', () => {
  ...
  it('should compile NOTIFICATION_PAYMENT_ATTACHMENT', () => {
    const route = NOTIFICATION_PAYMENT_ATTACHMENT('mocked-iun', 'mocked-attachmentName', 1);
    expect(route).toEqual(
      '/delivery/notifications/received/mocked-iun/attachments/payment/1/mocked-attachmentName'
    );
  });
