...
export const NotificationsApi = {
   ...
   * @returns Promise
   */
  getReceivedNotifications: (params: GetNotificationsParams): Promise<GetNotificationsResponse> => Promise.resolve(
    params 
    ? {
      resultsPage: [
        { iun: "KQKX-WMDW-GDMU-202301-L-1", notificationStatus: NotificationStatus.VIEWED, paProtocolNumber: "1133", recipients: ["titi", "toto"], sender: "tutu", sentAt: "Oggi", subject: "Prova 1"},
        { iun: "WRVL-PVGN-UZTK-202302-A-1", notificationStatus: NotificationStatus.VIEWED, paProtocolNumber: "1155", recipients: ["susu"], sender: "sisi", sentAt: "Oggi", subject: "Prova 2"},
      ],
      moreResult: false,
      nextPagesKey: []
    }
    ...
    getReceivedNotificationsReal: (params: GetNotificationsParams): Promise<GetNotificationsResponse> =>
  ...
  getReceivedNotification: (
    ...
    if (iun === "KQKX-WMDW-GDMU-202301-L-1") {
      return Promise.resolve(parseNotificationDetailForRecipient(mockedNotificationDetail(), currentUserTaxId, delegatorsFromStore));
    } else if (iun === "WRVL-PVGN-UZTK-202302-A-1") {
      return Promise.resolve(parseNotificationDetailForRecipient(mockedAnalogNotificationDetail(), currentUserTaxId, delegatorsFromStore));
    } else {
