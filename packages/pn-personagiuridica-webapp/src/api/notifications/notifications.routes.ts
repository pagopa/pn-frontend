...
const API_VERSION_V2_SEGMENT = 'v2';
...
const API_NOTIFICATION_PAYMENT_ATTACHMENT_PATH = `${API_NOTIFICATIONS_RECEIVED_PATH}/:${API_NOTIFICATIONS_IUN_PARAMETER}/${API_NOTIFICATIONS_ATTACHMENTS}/${API_NOTIFICATIONS_PAYMENT}/:${API_NOTIFICATIONS_RECIPIENT_INDEX_PARAMETER}/:${API_NOTIFICATIONS_ATTACHMENT_NAME_PARAMETER}`;
...
export function NOTIFICATION_DETAIL(iun: string, mandateId?: string) {
  return compileRoute({
    prefix: API_DELIVERY_PREFIX,
    version: API_VERSION_V2_SEGMENT,
